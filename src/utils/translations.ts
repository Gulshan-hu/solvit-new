...
export const translations = {
  az: {
    ...
    // 🟢 YENİ:
    invalidEmailFormat: 'E-poçt formatı səhvdir. (nümunə: ad.soyad@karabakh.edu.az)',
    yourRole: 'Rolunuz',
    teacher: 'Müəllim',
  ...
  ru: {
    ...
    // 🟢 YENİ:
    invalidEmailFormat: 'Неверный формат email. (пример: имя.фамилия@karabakh.edu.az)',
    yourRole: 'Ваша роль',
  ...
  en: {
    ...
    // 🟢 YENİ :
    invalidEmailFormat: 'Invalid email format. (example: name.surname@karabakh.edu.az)',
    yourRole: 'Your role',
    teacher: 'Teacher',
